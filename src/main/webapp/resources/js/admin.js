            ...
            confirm: {
                ...
                action: function () {
                    ...
                    for (var j = document.getElementsByClassName('rl_data').length/2 ;j<document.getElementsByClassName('rl_data').length;j++){
                        formVal[j] = document.getElementsByClassName('rl_data')[j].value;
                    }
                    // alert(this_url);

                    $.ajax({
                        url : BASE_PATH + '/sso/register',
                        type:"POST",
                        data : {
                            formval : formVal,
                            path_url : this_url
                        ...
                        success : function(result) {
                            showError(error_lable,result.msg);
                        },
            ...
            confirm: {
                ...
                action: function () {
                    ...
                    for (var k = document.getElementsByClassName('sz_data').length/2 ;k<document.getElementsByClassName('sz_data').length;k++){
                        // alert(document.getElementsByClassName('rl_data')[j].value);
                        // formVal[j] = getElementsByClassName('rl_data')[j].value;
                        formVal_2[k] = document.getElementsByClassName('sz_data')[k].value;
                        alert(formVal_2[k]);
                    }
