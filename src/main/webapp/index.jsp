...
<section id="main">
	...
	<aside id="sidebar">
		...
		<ul class="main-menu">
			<li>
				<a class="waves-effect" href="index.html"><i class="zmdi zmdi-home"></i> 首页</a>
			</li>
			...
			<li class="sub-menu system_menus system_1 3">
				...
				<ul>
					...
					<li><a class="waves-effect" href="javascript:add_bacColor('resources/data/stanSett.json');Tab.addTab('生长情况标准设置', 'dataList.html','/IntelligentSystem/api/UGlnR3Jvd3RoU2VydmljZTpzZXRHcm93dGhTdGFuZGFyZA');" id="stanSett">生长情况标准设置</a></li>
					<li><a class="waves-effect" href="javascript:add_bacColor('resources/data/equiOperCont.json');Tab.addTab('生长情况统计', 'dataList.html','/IntelligentSystem/api/R3Jvd3RoU3RhdGlzdGljc1NlcnZpY2U6Z3Jvd3RoU3RhdGlzdHVjcw');">生长情况统计</a></li>
					<li><a class="waves-effect" href="javascript:add_bacColor('resources/data/equiOperCont.json');Tab.addTab('疑似生病统计', 'dataList.html','/IntelligentSystem/api/UGlnRG91YnRmdWxJbGw6ZG91YnRmdWxJbGw');" id="equiOperCont">疑似生病统计</a></li>
				...
				<ul>
					...
					<li><a class="waves-effect" href="javascript:add_bacColor('resources/data/feedMana.json');Tab.addTab('饲喂管理', 'dataList.html','/IntelligentSystem/api/UGlnRmVlZFNldFNlcnZpY2U6c2V0RmVlZGluZw');" data-url='' id="feedMana">饲喂管理</a></li>
					<li><a class="waves-effect" href="javascript:add_bacColor('resources/data/formColl.json');Tab.addTab('配方搭配', 'dataList.html','/IntelligentSystem/api/UGlnRmVlZEZvcm11bGFTZXJ2aWNlOnNldEZvcm11bGE');" data-url='resources/data/formColl.json' id="formColl">配方搭配</a></li>
					<li><a class="waves-effect" href="javascript:add_bacColor('resources/data/feedStat.json');Tab.addTab('饲喂统计', 'dataList.html','/IntelligentSystem/api/UGlnSW5mb3JtYXRpb246aW5pdFBpZ0luZm9ybWF0aW9u');" data-url='resources/data/feedStat.json' id="feedStat">饲喂统计</a></li>

				</ul>
			</li>
					
					<li><a class="waves-effect" href="javascript:add_bacColor('resources/data/pigInfoMana.json');Tab.addTab('猪只信息管理', 'dataList.html','/IntelligentSystem/api/UGlnSW5mb3JtYXRpb246cGlnSW5mb3JtYXRpb24');" data-url='resources/data/pigInfoMana.json' id="pigInfoMana">猪只信息管理</a></li>
				...
				<ul>
					...
					<li><a class="waves-effect" href="javascript:add_bacColor('resources/data/vaccSett.json');Tab.addTab('疫苗接种设置', 'dataList.html','/IntelligentSystem/api/UGlnU2FmZU1hbmFnZVNlcnZpY2U6aW5vY3VsYXRpb25TZXQ');" data-url='resources/data/vaccSett.json' id="vaccSett">疫苗接种设置</a></li>
					<li><a class="waves-effect" href="javascript:add_bacColor('resources/data/diseMana.json');Tab.addTab('疾病管理', 'dataList.html','/IntelligentSystem/api/RGlzZWFzZVRyZWF0bWVudFNlcnZpY2U6ZGlzZWFzZVRyZWF0bWVudA');" data-url='resources/data/diseMana.json' id="diseMana">疾病管理</a></li>
					<li><a class="waves-effect" href="javascript:add_bacColor('resources/data/destMana.json');Tab.addTab('销毁管理', 'dataList.html','/IntelligentSystem/api/RGVzdHJveVNlcnZpY2U6d2lsbERlc3Ryb3k');" data-url='resources/data/destMana.json' id="destMana">销毁管理</a></li>
		   ...
		   <li class="sub-menu system_menus system_1 9">
			...
			<li class="sub-menu system_menus system_1 6">
				...
				<ul>
					<li><a class="waves-effect" href="javascript:add_bacColor('resources/data/rzgl.json');delete_add();Tab.addTab('日志管理', 'rzgl.html');" id="rzgl">日志管理</a></li>
					<li><a class="waves-effect" href="javascript:add_bacColor('resources/data/qxgl.json');delete_add();Tab.addTab('权限管理', 'qxgl.html');" id="qxgl">权限管理</a></li>
					<li><a class="waves-effect" href="javascript:add_bacColor('resources/data/sjk.json');delete_add();Tab.addTab('数据库备份与恢复', 'sjk.html');" id="sjk">数据库备份与恢复</a></li>
				</ul>
			</li>
			...
			<li class="sub-menu system_menus system_1 7">
				...
				<ul>
					<li><a class="waves-effect" href="javascript:add_bacColor('resources/data/userAudiActiDiag.json');delete_add();Tab.addTab('用户审核', 'dataList.html', 'resources/data/userAudiActiDiag.json');" data-url='resources/data/userAudiActiDiag.json' id="userAudiActiDiag">用户审核</a></li>
