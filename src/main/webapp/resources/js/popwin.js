...
$(document).ready(function() {
    ...
    $("#search").on('click' , function(){
        ...
        popWin.showWin("500","380","高级搜索","bestsearch.html");
...
showWin: function(width, height, title, src) {
        ...
        var inntHtml = '';
        var closeBtnHtml='<div style=" position: absolute;left: 78.6% ;top: 85.8%;"> <button type="button" class="btn btn-info" id="bestSearchSubmmit">提交</button> </div>';
        ...
        inntHtml += '<div id="maskTitle" style="height: 50px; line-height: 50px; font-family: Microsoft Yahei; font-size: 20px; color: whitesmoke; padding-left: 20px; background-color:#29a176; border-bottom: 1px solid #999999; position: relative;"> '
        inntHtml += '' + title + ''
        ...
        inntHtml += '</div>'
        inntHtml += '<iframe class="yijie" width="' + width + '" height="' + iframeHeight + '" frameborder="0" scrolling="' + this.scrolling + '" src="' + src + '"> </iframe> '+closeBtnHtml;
